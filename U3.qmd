...
## 4.2.3 Control Selectivo **Si-SiNoSi-SinoSi-FinSi.** 

El control selectivo excluyente de mas de dos alternativas. Solo se cumple a lo mas una de las $n$ alternativas.
```
Si <condición> Entonces  
    [Bloque de secuencia de instrucciones A];
SiNo Si<condicion>
...
## 4.2.4 Control selectivo de casos **Si-FinSi, Si-FinSi**
