...
2. Seleccion
    1 Si-FinSi (if)  
    2 Si-SiNo-FinSi, (if - elif)  
    3 Si, SiNo si - Sino Si FinSi(if - elseif)  
    4 Si-FinSi , Si-FinSi, Si-FinSi (casos (Switch - case)    )
    5 Si-FinSi anidados.
...
## 4.2.1 Control Selectivo **Si-FinSi** 

El control selectivo de una alternativa opcional Si-FinSi


```{=html}
<pre><code><span style="color:#0066cc; font-weight:bold;">Si</span> <span style="color:#cc0000;">&lt;condición&gt;</span> <span style="color:#0066cc; font-weight:bold;">Entonces</span>
  [Bloque de secuencia de instrucciones];
<span style="color:#0066cc; font-weight:bold;">FinSi</span>
</code></pre>
```
...
## 4.2.2 Control Selectivo **Si-SiNo-FinSi.** 

El control selectivo excluyente de dos alternativas  

Se cumple siempre solo **una** alternativa de las dos. 

```{=html}
<pre><code><span style="color:#0066cc; font-weight:bold;">Si</span> <span style="color:#cc0000;">&lt;condición&gt;</span> <span style="color:#0066cc; font-weight:bold;">Entonces</span>
  [Bloque de secuencia de instrucciones A];
<span style="color:#0066cc; font-weight:bold;">SiNo</span>
...
## 4.2.3 Control Selectivo **Si-SiNoSi-FinSi.** 

El control selectivo excluyente. En este ejemplo solo se cumple a lo mas una de las 2 alternativas.
```{=html}
<pre><code><span style="color:#0066cc; font-weight:bold;">Si</span> <span style="color:#cc0000;">&lt;condición&gt;</span> <span style="color:#0066cc; font-weight:bold;">Entonces</span>
    [Bloque de secuencia de instrucciones A];
<span style="color:#0066cc; font-weight:bold;">SiNo Si</span> <span style="color:#cc0000;">&lt;condición&gt;</span>
    [Bloque de secuencia de instrucciones B];
<span style="color:#0066cc; font-weight:bold;">FinSi</span>
</code></pre>
```
...
## 4.2.4 Control selectivo de casos con **Si-FinSi**

El control selectivo incluyente de mas de una alternativa. El cumplimiento de una condición no excluye a otra.

Se puede cumplir 0 o mas alternativas.

```{=html}
<pre><code><span style="color:#888;">\\ Caso 1</span>
<span style="color:#0066cc; font-weight:bold;">Si</span> <span style="color:#cc0000;">&lt;condición&gt;</span> <span style="color:#0066cc; font-weight:bold;">Entonces</span>
  [Bloque de secuencia de instrucciones A];
<span style="color:#0066cc; font-weight:bold;">FinSi</span>

<span style="color:#888;">\\ Caso 2</span>
<span style="color:#0066cc; font-weight:bold;">Si</span> <span style="color:#cc0000;">&lt;condición&gt;</span> <span style="color:#0066cc; font-weight:bold;">Entonces</span>
  [Bloque de secuencia de instrucciones B];
<span style="color:#0066cc; font-weight:bold;">FinSi</span>

<span style="color:#888;">\\ Caso 3</span>
<span style="color:#0066cc; font-weight:bold;">Si</span> <span style="color:#cc0000;">&lt;condición&gt;</span> <span style="color:#0066cc; font-weight:bold;">Entonces</span>
...
## 4.2.5 Control Selectivo Anidado {.smaller}

El cumplimiento de una condicional anidada depende del cumplimiento de la condición inmediata exterior.

El control selectivo se puede anidar. 
```{=html}
<pre><code><span style="color:#0066cc; font-weight:bold;">Si</span> <span style="color:#cc0000;">&lt;condicion1&gt;</span> <span style="color:#0066cc; font-weight:bold;">Entonces</span>

    <span style="color:#888;">//Opción 1</span>
    [Bloque de secuencia de instrucciones A];
    <span style="color:#0066cc; font-weight:bold;">Si</span> <span style="color:#cc0000;">&lt;condición2&gt;</span> <span style="color:#0066cc; font-weight:bold;">Entonces</span>

      <span style="color:#888;">//Opcion 2</span>
      [Bloque de secuencia de instrucciones B];
        <span style="color:#0066cc; font-weight:bold;">Si</span> <span style="color:#cc0000;">&lt;condición3&gt;</span> <span style="color:#0066cc; font-weight:bold;">Entonces</span>

            <span style="color:#888;">//Opción 3</span>
            [Bloque de secuencia de instrucciones C];

            <span style="color:#0066cc; font-weight:bold;">Si</span> <span style="color:#cc0000;">&lt;condición4&gt;</span> <span style="color:#0066cc; font-weight:bold;">Entonces</span>

                <span style="color:#888;">//Opcion 4</span>
                [Bloque de secuencia de instrucciones D];

            <span style="color:#0066cc; font-weight:bold;">FinSi</span></span>
...
## Apendice 4.2.5 Control Selectivo Anidado(**Si/If**) {.smaller}
